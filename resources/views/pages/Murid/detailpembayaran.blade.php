...
<form class="w-full" action={{url("/murid/dokirimbuktitf/$datadetail->pendaftaranmurid_id")}} method="POST">
    ...
    <div class="flex items-center mb-6 w-full">
        ...
        <div class="w-3/4">
          <input {{ $datadetail->pendaftaranmurid_status==-1 ? '' : 'disabled' }} class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-buktitf" type="file" value="{{$datadetail->pendaftaranmurid_buktibayar}}">
        </div>
    </div>
