    ...
    <div class="w-full flex justify-center items-center">
        <div class="w-full ">
            ...
            <div class="w-full p-10 flex flex-wrap" id="modal">
                ...
                @php
                    $foto=$datadetailguru->pengguna_photo;
                @endphp
                    <label
                    ...
                    <div class="w-4/6 pl-5">
                        <div class="flex items-center mb-6 w-full">
                            ...
                            <div class="w-3/4">
                              <input name="pengguna_nama" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-id" type="text" value="{{$datadetailguru->pengguna_nama}}">
                            </div>
                          </div>
                        <div class="flex items-center mb-6 w-full">
                          <div class="w-1/4">
                          ...
                          <div class="w-3/4">
                            <input disabled="disabled" name="pengguna_email" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" value="{{$datadetailguru->pengguna_email}}">
                          </div>
                        </div>
                        <div class="flex items-center mb-6 w-full">
                          <div class="w-1/4">
                          ...
                          <div class="w-3/4">
                            <input name="pengguna_nohp" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-email" type="text" value="{{$datadetailguru->pengguna_nohp}}">
                          </div>
                        </div>
                        <div class="flex items-center mb-6 w-full">
                            <div class="w-1/4">
                            ...
                            <div class="w-3/4">
                                <select id="pengguna_jeniskelamin" name="pengguna_jeniskelamin" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" >
                                    ...
                                    <option value=0 @if($datadetailguru->pengguna_jeniskelamin == 0) selected @endif>Laki-Laki</option>
                                    <option value=1 @if($datadetailguru->pengguna_jeniskelamin == 1) selected @endif>Perempuan</option>
                        ...
                        <div class="flex items-center mb-6 w-full">
                            ...
                            <div class="w-3/4">
                              <input name="pengguna_alamat" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-email" type="text" value="{{$datadetailguru->pengguna_alamat}}">
                            </div>
                          </div>
...
<div class="font-bold text-center text-2xl">Daftar Kelas Guru </div>
              ...
              <div class="py-4 inline-block min-w-full sm:px-6 lg:px-8">
                <div class="overflow-hidden">
                  <table class="min-w-full text-center">
                    ...
                    <tbody>
                        @if(count($datadetailguru->AdalahGuru->punyaKelas)==0)
                        <tr>
                        ...
                        @php
                            $x=0;
                        @endphp
                        @foreach ($datadetailguru->AdalahGuru->punyaKelas as $k)
                        @php
                            $x++;
                        @endphp
                        <tr>
                            <td class="px-6 py-4 border border-slate-500 whitespace-nowrap text-sm font-medium text-gray-900">{{$x}}</td>
                            <td class="px-6 py-4 border border-slate-500 whitespace-nowrap text-sm font-medium text-gray-900">{{$datadetailguru->pengguna_nama}}</td>
                            <td class="px-6 py-4 border border-slate-500 whitespace-nowrap text-sm font-medium text-gray-900">{{$k->kelas_nama}}</td>
