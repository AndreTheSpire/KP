            ...
            <tbody>
                @foreach ($data_guru as $data_daftar_guru)
                    <tr>
                        ...
                        <td class="border border-slate-600 text-center w-full"><a href="/admin/detailwawancaraguru/{{$data_daftar_guru->pengguna_id}}"><button class="bg-orange-600 hover:bg-orange-300 text-white font-bold py-2 px-4 rounded-full" type="button">Detail</button></a></td>
                    </tr>
                @endforeach
            </tbody>
        </table> --}}
