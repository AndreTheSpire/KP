...
<dialog id="myModal" class="w-11/12 md:w-1/2 p-5  bg-white rounded-md ">
    <div class="flex flex-col w-full h-auto ">
        ...
        <form action={{url("/admin/detailwawancaraguru/$data_detail->pengguna_id/confirm")}} method="GET">
            @csrf
            <div class="flex w-full py-10 px-2 justify-center items-center rounded text-center text-gray-500">
                <div class="lg:col-span-2">
                    ...
                    <div class="md:col-span-6 text-right">
                            <button type="submit" class="bg-red-600 hover:bg-red-400 text-white font-bold py-2 px-4 my-2 rounded">Submit</button>
