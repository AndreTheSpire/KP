...
@include('sweetalert::alert')
                    ...
                    @foreach ($dataPelajaran as $d)
                        <tr class="bg-white border-b">
                            ...
                            <td class="text-sm text-gray-900 border border-slate-500 font-light px-6 py-4 whitespace-nowrap">
                                <a onclick="updatepelajaran({{$d->pelajaran_id}},'{{$d->pelajaran_nama}}')">
                                ...
                                <a onclick="deletepelajaran({{$d->pelajaran_id}})">
    ...
    <dialog id="myModal2" class="w-11/12 md:w-1/2 p-5  bg-white rounded-md ">
        <div class="flex flex-col w-full h-auto ">
            ...
            <form action={{url("/admin/tambahpelajaran")}} id="formpelajaran" method="POST">
                @csrf
                <div class="flex w-full py-10 px-2 justify-center items-center rounded text-center text-gray-500">
                    <div class="lg:col-span-2">
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                        <div class="md:col-span-6">
                        <label for="pelajaranupdate">Nama Pelajaran</label>
                        <input type="text" name="pelajaranupdate" id="pelajaranupdate" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  />
                        </div>
                        <div class="md:col-span-6 text-right">
                            <div class="inline-flex items-endt">
                                <button type="submit" class="bg-red-600 hover:bg-red-400 text-white font-bold py-2 px-4 rounded">Submit</button>
        ...
        <div class="flex w-full h-auto justify-end items-center">
            ...
            <div onclick="document.getElementById('myModal3').close();" class="flex w-1/12 h-auto justify-center cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                    ...
                    <div class="mt-4">
                        <div>apakah kamu yakin untuk menghapus pelajaran ini?</div>
                        <button class="w-1/5 float-right px-6 py-2 mt-4 text-white bg-red-600 rounded-lg hover:bg-red-400" onclick="document.getElementById('myModal3').close();">No</button>
