...
<button class="bg-blue-500 hover:bg-blue-700 text-white mx-2 font-bold py-2 px-4 rounded"onclick="document.getElementById('myModal').showModal()">Tambah kategori</button>
    ...
    @foreach ($dataPelajaran as $d)
        ...
        <div class="py-4 inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <table class="min-w-full text-center">
                ...
                <tr>
                    <th scope="col" class="text-sm font-medium text-white px-6 py-4">ID Kategori</th>
                    <th scope="col" class="text-sm font-medium text-white px-6 py-4">Nama Kategori</th>
                    ...
                    @foreach ($dataKategori as $k)
                        @if ($d->pelajaran_id==$k->pelajaran_id)
                            <tr class="bg-white border-b">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$k->kategorikelas_id}}</td>
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{$k->kategorikelas_nama}}</td>
