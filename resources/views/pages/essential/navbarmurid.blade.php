...
<div class="md:fixed md:w-full md:top-0 md:z-20 flex sticky top-0 flex-row flex-wrap items-center bg-white p-2 border-b border-gray-300">
    ...
    <div id="navbar" class="animated md:hidden md:fixed md:top-0 md:w-full md:left-0 md:mt-16 md:border-t md:border-b md:border-gray-200 md:p-10 md:bg-white flex-1 pl-3 flex flex-row flex-wrap justify-between items-center md:flex-col md:items-center">
      ...
      <div class="text-gray-600 md:w-full md:flex md:flex-row md:justify-evenly md:pb-10 md:mb-10 md:border-b md:border-gray-200">
        <a class="mr-5 transition duration-500 ease-in-out hover:text-gray-900" href="/murid" title="Home"><i class="fad fa-home"></i> Home</a>
        <a class="mr-5 transition duration-500 ease-in-out hover:text-gray-900" href="/murid/kelas" title="Kelas"><i class="fad fa-users"></i> Kelas</a>
        <a class="mr-5 transition duration-500 ease-in-out hover:text-gray-900" href="/murid/todo" title="To-Do"><i class="fa fa-list-ul"></i> To-Do</a>
      ...
      <div class="flex flex-row-reverse items-center">
        ...
        <div class="dropdown relative md:static">
          ...
          <div class="text-gray-500 menu hidden md:mt-10 md:w-full rounded bg-white shadow-md absolute z-20 right-0 w-40 mt-5 py-2 animated faster">
            ...
            <a class="px-4 py-2 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 ease-in-out" href={{url("/murid/pembayaran")}}>
            ...
            <!-- item -->
            <a class="px-4 py-2 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 ease-in-out" href="/murid/notifikasi">
        ...
        <div class="dropdown relative mr-5 md:static">
          ...
          <div class="menu hidden rounded bg-white md:right-0 md:w-full shadow-md absolute z-20 right-0 w-84 mt-5 py-2 animated faster">
            ...
            <div class="px-4 py-2 mt-2">
              <a href="/murid/notifikasi" class="border border-gray-300 block text-center text-xs uppercase rounded p-1 hover:text-teal-500 transition-all ease-in-out duration-500">
                view all
              </a>
            </div>
            <!-- end bottom -->
