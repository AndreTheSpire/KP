...
<dialog id="myModal2" class="w-1/2 md:w-1/2 p-5  bg-white rounded-md ">
    ...
    <div class="flex w-full h-auto justify-end items-center">
        ...
        <div onclick="tutup('{{$dataKelas->kelas_id}}')" class="flex w-1/12 h-auto justify-center cursor-pointer">
            ...
            <form action="{{url('/guru/kelas/'.$dataKelas->kelas_id.'/addfeed')}}" method="POST" id="forminput"  enctype="multipart/form-data">
                ...
                <div class="mt-4">
                    ...
                    <button class="w-1/5 float-right px-6 py-2 mt-4  bg-red-600 text-white hover:bg-red-400 rounded-lg ">Post</button>
        ...
        <div onclick="document.getElementById('myModal3').close();" class="flex w-1/12 h-auto justify-center cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                ...
                <div class="mt-4">
                    ...
                    <a href="" id="yes"><button class="w-1/5 mx-4 float-right px-6 py-2 mt-4  bg-red-600 text-white hover:bg-red-400 rounded-lg ">Yes</button></a>
