...
<dialog id="myPass" class="w-6/12 md:w-1/2 p-5  bg-white rounded-md ">
    ...
    <div class="flex w-full h-auto justify-end items-center">
        ...
        <div onclick="document.getElementById('myPass').close();" class="flex w-1/12 h-auto justify-center cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
        </div>
    </div>
            <form action={{url("/updatepassword")}} method="POST">
                ...
                <div class="mt-4">
                    <div>
                        <label class="block" for="Name">Current Password<label>
                                <input type="password" placeholder="Current Password" name="current_password"
                                    class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600" >
                    </div>
                    <div class="mt-4">
                        <label class="block" for="email">New Password<label>
                                <input type="password" placeholder="New Password" name="new_password"
                                    class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                    </div>
                    <div class="mt-4">
                        <label class="block" for="email">Confirm New Password<label>
